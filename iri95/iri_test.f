...
1	print *,'jmag(=0/1,geog/geom),lati/deg,long/deg'
	...
	print *,'(enter 0 for list of peak heights and densities)'
        print *,'(enter -1 for plasma frequencies and profile',
     &		' parameters)'
	read(5,*) hx
	...
	print *,'Standard: t,t,t,t,f,f,t,t,t,t,t,t,t,t,t,t,t'
	...
	read(5,*) jf(6)
	print *,'Ne Topside mod.: t=standard, f=IRI-79 topside {t}'
	read(5,*) jf(7)
	...
	read(5,*) jf(11)
	print *,'Message output unit: t=(UNIT=6), f=(UNIT=12).'
	read(5,*) jf(12)
	...
	read(5,*) jf(16)
	print *,'Sunspot index: t=from file, f=user input.'
	read(5,*) jf(17)
